...
local worldList = {2753915549, 4442272183}
local Players = game:GetService("Players")
local PlayersList = #Players:GetPlayers() or 0
if table.find(worldList, game.PlaceId) and PlayersList > 1 then
